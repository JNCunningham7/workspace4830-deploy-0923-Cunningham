...
public class UtilProp {
   ...
   static String _PROP_FILENAME_OSX_LOCAL = "/Users/JCunningham/Desktop/Intro to Software Engineering/Tech Exercise/git-Cunningham/webproject/WebContent/config.properties";
   // * Remote server path
